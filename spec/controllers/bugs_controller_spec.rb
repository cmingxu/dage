...
describe BugsController do
  ...
  let(:valid_attributes) { { "desc" => "MyText" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # BugsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET show" do
    it "assigns the requested bug as @bug" do
      bug = Bug.create! valid_attributes
      get :show, {:id => bug.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested bug as @bug" do
      bug = Bug.create! valid_attributes
      get :edit, {:id => bug.to_param}, valid_session
      assigns(:bug).should eq(bug)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved bug as @bug" do
        ...
        post :create, {:bug => { "desc" => "invalid value" }}, valid_session
        assigns(:bug).should be_a_new(Bug)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested bug" do
        ...
        Bug.any_instance.should_receive(:update_attributes).with({ "desc" => "MyText" })
        put :update, {:id => bug.to_param, :bug => { "desc" => "MyText" }}, valid_session
      end

      it "assigns the requested bug as @bug" do
        bug = Bug.create! valid_attributes
        put :update, {:id => bug.to_param, :bug => valid_attributes}, valid_session
        assigns(:bug).should eq(bug)
      end
    ...
    describe "with invalid params" do
      it "assigns the bug as @bug" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Bug.any_instance.stub(:save).and_return(false)
        put :update, {:id => bug.to_param, :bug => { "desc" => "invalid value" }}, valid_session
        assigns(:bug).should eq(bug)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested bug" do
      bug = Bug.create! valid_attributes
      expect {
        delete :destroy, {:id => bug.to_param}, valid_session
      }.to change(Bug, :count).by(-1)
    end
