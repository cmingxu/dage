  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved driver as @driver" do
        ...
        post :create, {:driver => { "name" => "invalid value" }}, valid_session
        assigns(:driver).should be_a_new(Driver)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested driver" do
        ...
        Driver.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => driver.to_param, :driver => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the driver as @driver" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Driver.any_instance.stub(:save).and_return(false)
        put :update, {:id => driver.to_param, :driver => { "name" => "invalid value" }}, valid_session
        assigns(:driver).should eq(driver)
      end
